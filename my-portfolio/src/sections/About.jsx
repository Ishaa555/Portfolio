...
export default function About(){
  const stats = [
    ...
    {label:'Completed', value:'3+ Projects'},
  ]
  const glows =[
  ...
  return(
    ...
    className="min-h-screen w-full flex items-center justify-center relative bg-black text-white overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl w-full mx-auto px-6 md:px-10 lg:px-12 py-20 flex flex-col gap-12">
        <motion.div className='flex flex-col md:flex-col md:flex-row items-center md:items-stretch gap-8'
        ...
        >
          ...
          rounded-2xl overflow-hidden shadow-2xl bg-gradient-to-br from-[#1cd8d2]/20 to-[#302b63]/20 border border-[#1cd8d2]/2
          "
          whileHover={{scale:1.02}}
          transition={{type:'spring',stiffness:200,damping:18}}
          >

            <img src={Isha} alt="profile"  className="w-full h-full object-cover" />
            </motion.div>
            ...
            <div className="flex-1 flex flex-col justify-center text-center md:text-left">
              ...
              <p className="mt-4 text-gray-300 leading-relaxed text-base sm:text-lg max-w-2xl md:max-w-3xl">
                I build scalable,modern applications with a strong focus on clean arcitecture, delightful UX,and
                performance.My toolkit spans C++,React,Express.js,Node.js,Tailwind CSS,and RestfulAPI - bringing ideas
                to life from concept to production with robust APIs and smooth interfaces.
              </p>
        ...
        >
          ...
          I'm a Software Developer,Web Developer,and Content Creator - passionate about building fast,resilient
          applications .
          </p>
