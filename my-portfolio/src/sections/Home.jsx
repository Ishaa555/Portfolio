...
const socials = [
  ...
  { Icon: FaLinkedin, label: "LinkedIn", href: "https://www.linkedin.com/in/inderaneela-sarkar-21b8342a1/" },
  { Icon: FaGithub, label: "GitHub", href: "https://github.com/Ishaa555" },
];
        ...
        <div className="flex flex-col justify-center h-full text-center lg:text-left">
          <div className="w-full lg:pr-24 mx-auto max-w-[48rem]">
            ...
            >
              ...
              <a
                href="/InderaneelaSarkar_InternshalaResume (1).pdf"
                download
